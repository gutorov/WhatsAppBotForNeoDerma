...
public interface AssistantTest {
    ...
    @SystemMessage("""
            ...
            для этого вам нужно в конце диалога задать вопрос - подтверждает ли клиент свою запись и предоставить указанные клиентом ранее данные.
            Только успешное выполнение финального инструмента означает, что запись прошла успешно и полностью.
            """)
    @UserMessage("""
