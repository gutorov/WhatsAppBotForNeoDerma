...
public interface AssistantTest {
    ...
    @SystemMessage("""
            ...
            Имя нужно всегда узнавать в начале диалога, даже если клиент уже даёт информацию по другим вещам - сначала уточнить имя, а после 
            обработать другую информацию.
